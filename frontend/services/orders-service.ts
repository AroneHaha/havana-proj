...
const MOCK_ORDERS: Order[] = [
  {
    ...
    subtotal: 139.800, deliveryFee: 0, total: 139.800, status: "pending", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 361.700, deliveryFee: 0, total: 361.700, status: "confirmed", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 78.000, deliveryFee: 3.000, total: 81.000, status: "preparing", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 103.000, deliveryFee: 3.000, total: 106.000, status: "out_for_delivery", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 179.800, deliveryFee: 0, total: 179.800, status: "delivered", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 69.900, deliveryFee: 3.000, total: 72.900, status: "delivered", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 290.000, deliveryFee: 0, total: 290.000, status: "delivered", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 126.000, deliveryFee: 0, total: 126.000, status: "cancelled", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 144.000, deliveryFee: 3.000, total: 147.000, status: "delivered", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 62.000, deliveryFee: 3.000, total: 65.000, status: "pending", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 185.900, deliveryFee: 0, total: 185.900, status: "pending", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    items: [{ productId: "fp1", productName: "Royal Rose Symphony", quantity: 1, price: 69.900 }],
    subtotal: 69.900, deliveryFee: 3.000, total: 72.900, status: "confirmed", paymentMethod: "cash_on_delivery",
  ...
  // ─── Additional mock orders spanning 2024-2026 ───
  {
    ...
    subtotal: 99.900, deliveryFee: 0, total: 99.900, status: "delivered", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 193.900, deliveryFee: 3.000, total: 196.900, status: "delivered", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 89.900, deliveryFee: 0, total: 89.900, status: "delivered", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 234.000, deliveryFee: 0, total: 234.000, status: "delivered", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 151.000, deliveryFee: 3.000, total: 154.000, status: "delivered", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 349.500, deliveryFee: 0, total: 349.500, status: "delivered", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 189.800, deliveryFee: 0, total: 189.800, status: "delivered", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    items: [{ productId: "fp2", productName: "Golden Hour Bouquet", quantity: 1, price: 62.000 }],
    subtotal: 62.000, deliveryFee: 3.000, total: 65.000, status: "delivered", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 204.000, deliveryFee: 0, total: 204.000, status: "delivered", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 110.000, deliveryFee: 3.000, total: 113.000, status: "delivered", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 159.800, deliveryFee: 0, total: 159.800, status: "cancelled", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 199.800, deliveryFee: 0, total: 199.800, status: "delivered", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 186.000, deliveryFee: 0, total: 186.000, status: "delivered", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 217.800, deliveryFee: 3.000, total: 220.800, status: "delivered", paymentMethod: "cash_on_delivery",
  ...
  },
  {
    ...
    subtotal: 227.800, deliveryFee: 0, total: 227.800, status: "delivered", paymentMethod: "cash_on_delivery",
