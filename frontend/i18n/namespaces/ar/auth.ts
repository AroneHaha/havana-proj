...
const auth = {
  auth: {
    login: {
      ...
      forgotPasswordSend: "إرسال رابط التعيين",
      forgotPasswordSent: "تم إرسال رابط التعيين! تحقق من بريدك الإلكتروني.",
    ...
    signup: {
      ...
      successMessage: "تم إنشاء حسابك في هافانا فلاورز بنجاح. يرجى التحقق من بريدك الإلكتروني لتأكيد حسابك قبل تسجيل الدخول. إذا لم يكن التأكيد مطلوباً، يمكنك تسجيل الدخول فوراً.",
