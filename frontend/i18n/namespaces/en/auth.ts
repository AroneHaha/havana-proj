...
const auth = {
  auth: {
    login: {
      ...
      forgotPasswordSent: "Reset link sent! Check your email.",
    ...
    signup: {
      ...
      successMessage: "Your Havana Flowers account has been created successfully. Please check your email to verify your account before signing in. If no verification is required, you can sign in right away.",
