...
const en: Translation = {
  ...
  checkout: {
    ...
    fullName: "Full Name",
    fullNamePlaceholder: "e.g. Ahmad Al-Sabah",
    email: "Email",
    emailPlaceholder: "e.g. ahmad@email.com",
    phone: "Phone Number",
    phonePlaceholder: "e.g. +965 5551 0001",
    address: "Delivery Address",
    addressPlaceholder: "e.g. Salmiya, Block 12, St 5, Bldg 3",
    ...
    stockWarning: "Some items may have limited stock",
    stockUnavailable: "Some items are no longer available",
    orderPlaced: "Order Placed!",
    orderPlacedMessage: "Your order has been placed successfully. We will contact you to confirm delivery details.",
    orderNumber: "Order Number",
    continueShopping: "Continue Shopping",
    loginRequired: "Login Required",
    loginRequiredMessage: "Please sign in to place your order.",
    goToLogin: "Sign In",
    invalidPhone: "Please enter a valid Kuwait phone number (+965)",
