...
const recentOrders = [
  {
    id: "#HV-1042",
    customer: "Sara Al-Thani",
    product: "Royal Rose Symphony",
    amount: "QAR 699",
    statusKey: "delivered",
  },
  {
    ...
    product: "Golden Hour Bouquet",
    amount: "QAR 620",
    statusKey: "inTransit",
  },
  {
    id: "#HV-1040",
    customer: "Khalid Noor",
    product: "Midnight Orchid Elegance",
    amount: "QAR 999",
          ...
          >
              ...
              {stats.map((stat, i) => (
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div
                      className={`p-2 rounded-xl bg-muted/50 ${stat.color}`}
                    >
            ...
            <div className="bg-white dark:bg-dark-card rounded-2xl border border-border overflow-hidden">
              <div className="flex items-center justify-between px-6 py-4 border-b border-border">
                ...
                <Link
                  href="/orders"
                  className="text-sm text-maroon dark:text-gold font-medium hover:underline"
                >
                  {t.viewAll}
                </Link>
              </div>
                        ...
                        <td className="px-6 py-4">
                          <span
                            className={`inline-flex px-2.5 py-1 rounded-full text-xs font-medium ${
                              statusColors[order.statusKey] ??
                              "bg-muted text-muted-foreground"
                            }`}
                          >
                            {t[
                              order.statusKey as keyof typeof t
                            ]}
                          </span>
                        </td>
                      </tr>
