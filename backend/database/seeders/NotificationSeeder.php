    ...
    public function run(): void
    {
        ...
        $notifications = array_merge($notifications, [
            ...
            [
                ...
                'body_en' => 'Royal Union Fleur is running low on stock (5 remaining).',
                'body_ar' => 'زهرة الاتحاد الملكي ينخفض المخزون (5 متبقية).',
                'data' => ['product_slug' => 'royal-union-fleur', 'stock' => 5],
                'is_read' => false,
                'read_at' => null,
            ],
            [
                ...
                'title_en' => 'Low Stock Alert',
                'title_ar' => 'تنبيه مخزون منخفض',
                'body_en' => 'Rosewood Passion Fleur is running low on stock (6 remaining).',
                'body_ar' => 'زهرة شغف خشب الورد ينخفض المخزون (6 متبقية).',
                'data' => ['product_slug' => 'rosewood-passion-fleur', 'stock' => 6],
                'is_read' => false,
                'read_at' => null,
            ],
            [
